...
urlpatterns = [
                  ...
                  path('Hod/Staff/Send_Notification',Hod_Views.STAFF_SEND_NOTIFICCATION , name='staff_send_notification'),
                  ...
                  path('Hod/Student/send_Notification', Hod_Views.STUDENT_SEND_NOTIFICCATION, name='student_send_notification'),
                  path('Hod/Student/save_Notification', Hod_Views.SAVE_STUDENT_NOTIFICCATION, name='save_student_notification'),
                  ...
                  path('Hod/Student/Attendance', Hod_Views.STUDENT_ATTENDANCE, name='student_attendance'),
